...
const SOCKETTYPES_OUT: { [key in keyof Required<IntegerStopArrayDefinition["outputs"]>]: SocketTypes.SocketRule } = {
    output: { types: ["array<stop<integer>>"], mode: "and" },
    stopCount: { types: ["integer"], mode: "and" },
};

const getSocketType = (_node: NodeDefinitions.NodeFor<IntegerStopArrayDefinition>, socketId: string, side: "in" | "out"): SocketTypes.SocketRule => {
    if (side === "out") {
    ...
    return { types: ["array<stop<integer>>"], mode: "or" };
};
