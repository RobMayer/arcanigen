...
const dependsOn = (_node: NodeDefinitions.NodeFor<StopFloatBreakoutDefinition>, outSocket: keyof StopFloatBreakoutDefinition["outputs"], _deps: AllDeps): (keyof StopFloatBreakoutDefinition["inputs"])[] => {
    if (outSocket === "output") {
...
const contributesTo = (_node: NodeDefinitions.NodeFor<StopFloatBreakoutDefinition>, inSocket: keyof StopFloatBreakoutDefinition["inputs"], _deps: AllDeps): (keyof StopFloatBreakoutDefinition["outputs"])[] => {
...
export const FloatStopNodeType: NodeTypes.Type<"floatStop", StopFloatBreakoutDefinition> = {
    ...
    iconNode: <Icon shape={NODE_ICONS.modifiers.stopOf} color={"var(--icon-flavour)"} />,
