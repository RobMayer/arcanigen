...
export type MaxDefinition = SignatureBuilder.DefinitionFrom<typeof def, PayloadType>;

const create = (_input: Partial<NodeDefinitions.PayloadTypeOf<MaxDefinition>>, id: string = nanoid()): NodeDefinitions.BuiltNodeOf<"max", MaxDefinition> => {
    return {
        id,
        in: {
            a: null,
