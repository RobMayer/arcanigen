...
const POLYRING_SOCKET_TYPES: Record<string, string> = {
    pointCount: "integer",
    radius: "length",
    spread: "length",
    innerRadius: "length",
...
export const PolyringNodeType: NodeTypes.Type<"polyring", PolyringDefinition> = {
    ...
    iconNode: <Icon shape={NODE_ICONS.polyringShape.Item} color={"var(--icon-flavour)"} />,
    iconCard: <Icon shape={NODE_ICONS.polyringShape.Card} color={"var(--icon-flavour)"} />,
    category: "Shapes",
    create,
    dependsOn,
    contributesTo,
