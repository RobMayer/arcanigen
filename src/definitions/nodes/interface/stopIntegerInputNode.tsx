...
const contributesTo = (_node: NodeDefinitions.NodeFor<StopIntegerInputDefinition>, _inSocket: keyof StopIntegerInputDefinition["inputs"], _deps: AllDeps): (keyof StopIntegerInputDefinition["outputs"])[] => {
    return [];
};
