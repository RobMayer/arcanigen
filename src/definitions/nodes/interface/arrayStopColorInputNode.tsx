...
const create = (_input: Partial<NodeDefinitions.PayloadTypeOf<ArrayStopColorInputDefinition>>, id: string = nanoid()): NodeDefinitions.BuiltNodeOf<"arrayStopColorInput", ArrayStopColorInputDefinition> => {
    return {
        id,
        in: {},
        out: {
...
const contributesTo = (_node: NodeDefinitions.NodeFor<ArrayStopColorInputDefinition>, _inSocket: keyof ArrayStopColorInputDefinition["inputs"], _deps: AllDeps): (keyof ArrayStopColorInputDefinition["outputs"])[] => {
    return [];
};
