...
const onCreate = (node: NodeDefinitions.BuiltNodeOf<"tokensLengthOutput", TokensLengthOutputDefinition>, state: NodeTypes.HookState, graphId: string): NodeTypes.HookState => {
    return addInterface(state, graphId, node.id, "out");
};

const onDelete = (node: NodeDefinitions.BuiltNodeOf<"tokensLengthOutput", TokensLengthOutputDefinition>, state: NodeTypes.HookState, graphId: string): NodeTypes.HookState => {
