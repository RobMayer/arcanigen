...
const dependsOn = (_node: NodeDefinitions.NodeFor<StopAngleOutputDefinition>, _outSocket: keyof StopAngleOutputDefinition["outputs"], _deps: AllDeps): (keyof StopAngleOutputDefinition["inputs"])[] => {
    return [];
};

const contributesTo = (_node: NodeDefinitions.NodeFor<StopAngleOutputDefinition>, _inSocket: keyof StopAngleOutputDefinition["inputs"], _deps: AllDeps): (keyof StopAngleOutputDefinition["outputs"])[] => {
    return [];
};
