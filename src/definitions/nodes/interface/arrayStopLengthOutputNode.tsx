...
const create = (_input: Partial<NodeDefinitions.PayloadTypeOf<ArrayStopLengthOutputDefinition>>, id: string = nanoid()): NodeDefinitions.BuiltNodeOf<"arrayStopLengthOutput", ArrayStopLengthOutputDefinition> => {
    return {
        id,
        in: {
            input: null,
...
const dependsOn = (_node: NodeDefinitions.NodeFor<ArrayStopLengthOutputDefinition>, _outSocket: keyof ArrayStopLengthOutputDefinition["outputs"], _deps: AllDeps): (keyof ArrayStopLengthOutputDefinition["inputs"])[] => {
    return [];
};

const contributesTo = (_node: NodeDefinitions.NodeFor<ArrayStopLengthOutputDefinition>, _inSocket: keyof ArrayStopLengthOutputDefinition["inputs"], _deps: AllDeps): (keyof ArrayStopLengthOutputDefinition["outputs"])[] => {
    return [];
};
