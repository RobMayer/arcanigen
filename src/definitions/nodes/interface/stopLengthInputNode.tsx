...
const contributesTo = (_node: NodeDefinitions.NodeFor<StopLengthInputDefinition>, _inSocket: keyof StopLengthInputDefinition["inputs"], _deps: AllDeps): (keyof StopLengthInputDefinition["outputs"])[] => {
    return [];
};
