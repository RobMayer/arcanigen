...
const dependsOn = (_node: NodeDefinitions.NodeFor<StopFloatOutputDefinition>, _outSocket: keyof StopFloatOutputDefinition["outputs"], _deps: AllDeps): (keyof StopFloatOutputDefinition["inputs"])[] => {
    return [];
};

const contributesTo = (_node: NodeDefinitions.NodeFor<StopFloatOutputDefinition>, _inSocket: keyof StopFloatOutputDefinition["inputs"], _deps: AllDeps): (keyof StopFloatOutputDefinition["outputs"])[] => {
    return [];
};
