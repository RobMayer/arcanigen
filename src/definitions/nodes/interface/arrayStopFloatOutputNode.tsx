...
const create = (_input: Partial<NodeDefinitions.PayloadTypeOf<ArrayStopFloatOutputDefinition>>, id: string = nanoid()): NodeDefinitions.BuiltNodeOf<"arrayStopFloatOutput", ArrayStopFloatOutputDefinition> => {
    return {
        id,
        in: {
            input: null,
...
const dependsOn = (_node: NodeDefinitions.NodeFor<ArrayStopFloatOutputDefinition>, _outSocket: keyof ArrayStopFloatOutputDefinition["outputs"], _deps: AllDeps): (keyof ArrayStopFloatOutputDefinition["inputs"])[] => {
    return [];
};

const contributesTo = (_node: NodeDefinitions.NodeFor<ArrayStopFloatOutputDefinition>, _inSocket: keyof ArrayStopFloatOutputDefinition["inputs"], _deps: AllDeps): (keyof ArrayStopFloatOutputDefinition["outputs"])[] => {
    return [];
};
