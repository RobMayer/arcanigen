...
const contributesTo = (_node: NodeDefinitions.NodeFor<StopColorInputDefinition>, _inSocket: keyof StopColorInputDefinition["inputs"], _deps: AllDeps): (keyof StopColorInputDefinition["outputs"])[] => {
    return [];
};
