...
const create = (_input: Partial<NodeDefinitions.PayloadTypeOf<ArrayStopColorOutputDefinition>>, id: string = nanoid()): NodeDefinitions.BuiltNodeOf<"arrayStopColorOutput", ArrayStopColorOutputDefinition> => {
    return {
        id,
        in: {
            input: null,
...
const dependsOn = (_node: NodeDefinitions.NodeFor<ArrayStopColorOutputDefinition>, _outSocket: keyof ArrayStopColorOutputDefinition["outputs"], _deps: AllDeps): (keyof ArrayStopColorOutputDefinition["inputs"])[] => {
    return [];
};

const contributesTo = (_node: NodeDefinitions.NodeFor<ArrayStopColorOutputDefinition>, _inSocket: keyof ArrayStopColorOutputDefinition["inputs"], _deps: AllDeps): (keyof ArrayStopColorOutputDefinition["outputs"])[] => {
    return [];
};
