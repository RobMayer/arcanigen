...
const dependsOn = (_node: NodeDefinitions.NodeFor<StopLengthOutputDefinition>, _outSocket: keyof StopLengthOutputDefinition["outputs"], _deps: AllDeps): (keyof StopLengthOutputDefinition["inputs"])[] => {
    return [];
};

const contributesTo = (_node: NodeDefinitions.NodeFor<StopLengthOutputDefinition>, _inSocket: keyof StopLengthOutputDefinition["inputs"], _deps: AllDeps): (keyof StopLengthOutputDefinition["outputs"])[] => {
    return [];
};
