...
const create = (_input: Partial<NodeDefinitions.PayloadTypeOf<ArrayStopAngleOutputDefinition>>, id: string = nanoid()): NodeDefinitions.BuiltNodeOf<"arrayStopAngleOutput", ArrayStopAngleOutputDefinition> => {
    return {
        id,
        in: {
            input: null,
...
const dependsOn = (_node: NodeDefinitions.NodeFor<ArrayStopAngleOutputDefinition>, _outSocket: keyof ArrayStopAngleOutputDefinition["outputs"], _deps: AllDeps): (keyof ArrayStopAngleOutputDefinition["inputs"])[] => {
    return [];
};

const contributesTo = (_node: NodeDefinitions.NodeFor<ArrayStopAngleOutputDefinition>, _inSocket: keyof ArrayStopAngleOutputDefinition["inputs"], _deps: AllDeps): (keyof ArrayStopAngleOutputDefinition["outputs"])[] => {
    return [];
};
