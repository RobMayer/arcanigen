...
export type StopAngleInputDefinition = {
    inputs: never;
    outputs: {
...
const contributesTo = (_node: NodeDefinitions.NodeFor<StopAngleInputDefinition>, _inSocket: keyof StopAngleInputDefinition["inputs"], _deps: AllDeps): (keyof StopAngleInputDefinition["outputs"])[] => {
    return [];
};
...
const SOCKETTYPES_OUT: { [key in keyof Required<StopAngleInputDefinition["outputs"]>]: SocketTypes.SocketRule } = {
    output: { types: ["stop<angle>"], mode: "and" },
};

const getSocketType = (_node: NodeDefinitions.NodeFor<StopAngleInputDefinition>, socketId: string, _side: "in" | "out"): SocketTypes.SocketRule => {
