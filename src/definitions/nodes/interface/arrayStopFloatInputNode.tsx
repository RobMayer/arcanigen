...
const create = (_input: Partial<NodeDefinitions.PayloadTypeOf<ArrayStopFloatInputDefinition>>, id: string = nanoid()): NodeDefinitions.BuiltNodeOf<"arrayStopFloatInput", ArrayStopFloatInputDefinition> => {
    return {
        id,
        in: {},
        out: {
...
const contributesTo = (_node: NodeDefinitions.NodeFor<ArrayStopFloatInputDefinition>, _inSocket: keyof ArrayStopFloatInputDefinition["inputs"], _deps: AllDeps): (keyof ArrayStopFloatInputDefinition["outputs"])[] => {
    return [];
};
