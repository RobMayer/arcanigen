...
const dependsOn = (
    _node: NodeDefinitions.NodeFor<StopIntegerOutputDefinition>,
    _outSocket: keyof StopIntegerOutputDefinition["outputs"],
    _deps: AllDeps,
): (keyof StopIntegerOutputDefinition["inputs"])[] => {
    return [];
};

const contributesTo = (
    _node: NodeDefinitions.NodeFor<StopIntegerOutputDefinition>,
    _inSocket: keyof StopIntegerOutputDefinition["inputs"],
    _deps: AllDeps,
): (keyof StopIntegerOutputDefinition["outputs"])[] => {
    return [];
};
...
export const StopIntegerOutputType: NodeTypes.Type<"stopIntegerOutput", StopIntegerOutputDefinition> = {
    ...
    defaultLabel: "Integer Stop Output",
