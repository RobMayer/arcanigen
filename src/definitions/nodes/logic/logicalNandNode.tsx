...
export type LogicalNandDefinition = {
    inputs: {
...
const getSocketType = (_node: NodeDefinitions.NodeFor<LogicalNandDefinition>, _socketId: string, _side: "in" | "out"): SocketTypes.SocketRule => {
