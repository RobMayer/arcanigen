...
export type GreaterOrEqualDefinition = SignatureBuilder.DefinitionFrom<typeof def, PayloadType>;
...
const Controls = ({ node, methods }: { node: NodeDefinitions.NodeFor<GreaterOrEqualDefinition>; methods: ReturnType<typeof Project.useNode>[1] }): ReactNode => {
    ...
    const handleUpdate = useCallback(
        (v: Partial<NodeDefinitions.PayloadTypeOf<GreaterOrEqualDefinition>>) => {
            methods.update(v);
        },
        [methods],
    );
