...
const ACCEPTED_KEYS = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRow", "Home", "End", "PageUp", "PageDown"];
    ...
    ({
        ...
        const handleKeyDown = useCallback(
            (evt: React.KeyboardEvent<HTMLInputElement>) => {
                ...
                if (!ACCEPTED_KEYS.includes(evt.key)) return;
                evt.nativeEvent.handled = "implied";
                evt.preventDefault();
        ...
        return <AbstractSliderInput {...rest} min={min} max={max} step={step} value={cache} onChange={handleChange} onKeyDown={handleKeyDown} onBlur={handleBlur} />;
    },
)``;
