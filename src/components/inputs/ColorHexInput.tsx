...
const ColorHexInput = styled(({ className, value, onValue, onCommit, onSubmit, ref, nullable, alpha, onChange, onKeyDown, ...rest }: Omit<AbstractInputProps, "value"> & ColorHexInputProps) => {
    ...
    return (
        <div className={className}>
            ...
            <AbstractTextInput {...rest} type="text" value={cache} onChange={handleChange} onKeyDown={handleKeyDown} ref={makeRef} />
        </div>
    );
})`
    display: flex;
